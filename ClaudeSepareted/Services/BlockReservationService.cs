...
namespace ClaudeSepareted.Services
{
    ...
    public class BlockReservationService
    {
        ...
        public bool TryReserveBlock(string sectionName, string trainName)
        {
            ...
            lock (_reservationLock)
            {
                try
                {
                    ...
                    // Use atomic TryGetTrainInSection to prevent TOCTOU race condition
                    if (_occupancyService.TryGetTrainInSection(sectionName, out var physicalOccupant))
                    {
        ...
        ///
        /// Thread Safety:
        /// Uses atomic conditional removal via ICollection cast to prevent race conditions
        /// between the check and remove operations.
        /// </summary>
        ...
        /// Thread Safety:
        /// Uses atomic conditional removal via ICollection cast to prevent race conditions
        /// during the teardown of a train's reservations.
        /// </summary>
