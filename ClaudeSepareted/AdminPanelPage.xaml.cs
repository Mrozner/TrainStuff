...
namespace ClaudeSepareted
{
    public partial class AdminPanelPage : ContentPage
    {
        ...
        private readonly SwitchConfigurationService _switchService;
        ...
        public AdminPanelPage(
            ...
            SwitchConfigurationService switchService,
        ...
        private async void OnSyncSwitchesClicked(object sender, EventArgs e)
        {
            bool confirm = await DisplayAlert("Megerősítés", "Minden váltót alaphelyzetbe (egyenes) állítasz? Ez okozhat fizikai mozgást a terepasztalon.", "Igen", "Nem");
            if (confirm)
            {
                ...
                await _switchService.SyncAllSwitchesToDefaultAsync(dbContext);

                if (sender is Button btnRestore) btnRestore.IsEnabled = true;

                await DisplayAlert("Kész", "Hardver szinkronizáció befejeződött.", "OK");
            }
        }
