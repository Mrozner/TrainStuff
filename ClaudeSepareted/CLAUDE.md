...
**SwitchConfigurationService** (`Services/SwitchConfigurationService.cs`) - Switch lock management
...
11. Use SwitchConfigurationService for switch operations (includes automatic locking)
